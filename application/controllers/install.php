...
class Install extends CI_Controller {
	...
	public function index() {
		...
		$data['form_validated'] = '';
		// lecture des paramêtres de connexion à la bdd
	...
	//			$phase = $this->uri->segment(3);
		switch ($phase) {
			...
			case '3':
				...
				$this->form_validation->set_rules('user_username', '« '.lang('label_username').' »', 'required|min_length[8]|max_length[24]|alpha_dash');
				$this->form_validation->set_rules('sa_password', '« '.lang('label_password').' »', 'required|min_length[8]|max_length[16]|alpha_dash');
				$this->form_validation->set_rules('confirm_password', '« '.lang('label_confirm_it').' »', 'required|matches[sa_password]');
				// test de validation du formulaire
				if ($this->form_validation->run() == FALSE){
					// échec : ré-affichage du formulaire
