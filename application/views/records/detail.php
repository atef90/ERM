...
?>
			...
			<div id="togglePanelDetail">
				<table>
					<tr>
						<td style="width:180px"><?php echo lang('info_maked_on') . $this->all_model->timestamp_to_date($record['maked_on'], '') ; ?><br /><br /><?php echo lang('info_revised_on') . $this->all_model->timestamp_to_date($record['revised_on'], '[non modifié]') ; ?><br /><br /><?php echo lang('info_popularity') . $record['clicks']; ?><br /><br /><?php echo lang('info_confidentiality') . $record['visibility']; ?></td>
...
?>
			...
			<div id="togglePanelDetail">
				<div style="height: 60px;width: 400px;margin-left: auto;margin-right: auto;">
					<p class="align_left"><?php echo lang('info_maked_on') . $this->all_model->timestamp_to_date($record['maked_on'], '') ; ?><br /><br /><?php echo lang('info_revised_on') . $this->all_model->timestamp_to_date($record['revised_on'], '[non modifié]') ; ?></p>
...
?>
			...
			<div id="togglePanelDetail">
				<table>
					<tr>
						<td style="width:180px"><?php echo lang('info_maked_on');?><?php echo $this->all_model->timestamp_to_date($record['maked_on'], '') ; ?><br /><br /><?php echo lang('info_revised_on');?><?php echo $this->all_model->timestamp_to_date($record['revised_on'], '[non modifié]') ; ?><br /><br /><?php echo lang('info_popularity');?><?php echo $record['clicks']; ?><br /><br /><?php echo lang('info_confidentiality');?><?php echo $record['visibility']; ?></td>
						<td><textarea style="font-size: 12px;" name="memo" rows="5" cols="55" readonly="readonly"><?php echo $record['memo']; ?></textarea></td>
