...
// affectation des valeurs de champs communs à toutes les catégories
if($uid == 'not_set'){
	// cas d'une création
...
// début du formulaire('url', $attributes, $hidden) avec champs cachés pour itemid et uid
...
//		)) . "<img src=\"".base_url('resource/img/actions/add.png')."\" height=\"24\" width=\"44\" alt=\"vide\" />\r\n" ;
	...
	case "3":
		// affectation des valeurs de champs spécifiques
		if($uid == 'not_set'){
			// cas d'une création : groupe et visibility par défaut
