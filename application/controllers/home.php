...
class Home extends CI_Controller {
	...
	public function save_password() {
		...
		$this->form_validation->set_rules('new_password', '« '.lang('label_new_password').' »', 'required|min_length[8]|max_length[16]|alpha_dash');
		$this->form_validation->set_rules('confirm_password', '« '.lang('label_confirm_it').' »', 'required|min_length[8]|max_length[16]|alpha_dash');
